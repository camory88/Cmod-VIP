...
namespace Offsets
{
	...
	const inline uintptr_t client_render_targets = 0x1fdeea0;
	const inline uintptr_t ibase_client_dll = 0x19e1770;
	const inline uintptr_t iclient_entity_list = 0x1fde6b0;
	const inline uintptr_t cprediction = 0x1fde6b8;
	const inline uintptr_t iv_model_render = 0x128b080;
	const inline uintptr_t vgui_system = 0x1f98620;
	const inline uintptr_t iv_render_view = 0x7519718;
	const inline uintptr_t iv_debug_overlay = 0x75b48a0;
	const inline uintptr_t iv_model_info_client = 0x7519728;
	const inline uintptr_t iv_engine_client = 0x12799d8;
	const inline uintptr_t iv_engine_trace = 0x7519730;
	const inline uintptr_t inetwork_string_table = 0x7519740;
	const inline uintptr_t cnetwork_u64_table = 0x7519748;
	const inline uintptr_t cinput = 0x1d94ea0;
	const inline uintptr_t cengine = 0x1292410;
	const inline uintptr_t iswapchain = 0xb911e88;
	const inline uintptr_t cl_entitylist = 0x19fbc18;
	const inline uintptr_t local_entity_handle = 0x127d8bc;
	const inline uintptr_t local_player = 0x1dac9c8;
	const inline uintptr_t global_vars = 0x135c850;
	const inline uintptr_t name_list = 0xb9f7e40;
	const inline uintptr_t view_render = 0x1fdffb0;
	const inline uintptr_t view_matrix = 0x602381;
	const inline uintptr_t client_state = 0x135cbd0;
	const inline uintptr_t sign_on_state = 0x135cc68;
	const inline uintptr_t level_name = 0x135cd80;
	const inline uintptr_t glow_enable = 0x9a1;
